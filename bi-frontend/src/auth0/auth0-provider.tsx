...
import {
  ...
  User,
  type RedirectConnectAccountOptions,
...
import { reducer } from '@/auth0/reducer';
import { initialAuthState, type AuthState } from '@/auth0/auth-state';
 ...
 */
export interface Auth0ProviderOptions<TUser extends User = User> {
  client: Auth0Client;
